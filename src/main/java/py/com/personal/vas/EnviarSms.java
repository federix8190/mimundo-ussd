...
public class EnviarSms {
    ...
    @XmlElementRef(name = "Mensaje", namespace = "http://vas.personal.com.py", type = JAXBElement.class, required = false)
    protected JAXBElement<String> mensaje;
    @XmlElementRef(name = "Origen", namespace = "http://vas.personal.com.py", type = JAXBElement.class, required = false)
