 ...
 *         &lt;element name="LineaDestino" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlRootElement(name = "TransferenciaP2P")
public class TransferenciaP2P {
    ...
    @XmlElementRef(name = "LineaDestino", namespace = "http://vas.personal.com.py", type = JAXBElement.class, required = false)
    protected JAXBElement<String> lineaDestino;
    @XmlElementRef(name = "Monto", namespace = "http://vas.personal.com.py", type = JAXBElement.class, required = false)
    protected JAXBElement<String> monto;
    @XmlElementRef(name = "Pin", namespace = "http://vas.personal.com.py", type = JAXBElement.class, required = false)
    ...
    /**
     * Gets the value of the lineaDestino property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getLineaDestino() {
        return lineaDestino;
    }

    /**
     * Sets the value of the lineaDestino property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setLineaDestino(JAXBElement<String> value) {
        this.lineaDestino = value;
    }
