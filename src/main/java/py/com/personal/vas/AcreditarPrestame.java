...
@XmlRootElement(name = "AcreditarPrestame")
public class AcreditarPrestame {
    ...
    @XmlElementRef(name = "Canal", namespace = "http://vas.personal.com.py", type = JAXBElement.class, required = false)
