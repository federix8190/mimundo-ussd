...
@XmlRootElement(name = "ResetearClave")
public class ResetearClave {
    ...
    @XmlElementRef(name = "NuevaClave", namespace = "http://vas.personal.com.py", type = JAXBElement.class, required = false)
