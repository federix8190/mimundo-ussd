...
@XmlRootElement(name = "AcreditarMontosRecFact")
public class AcreditarMontosRecFact {
    ...
    @XmlElementRef(name = "Porcentaje", namespace = "http://vas.personal.com.py", type = JAXBElement.class, required = false)
