...
@XmlRootElement(name = "VerificarServicioNombre")
public class VerificarServicioNombre {
    ...
    @XmlElementRef(name = "Servicio", namespace = "http://vas.personal.com.py", type = JAXBElement.class, required = false)
