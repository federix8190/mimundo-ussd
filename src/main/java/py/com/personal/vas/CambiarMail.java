 ...
 *         &lt;element name="NuevoMail" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "CambiarMail")
public class CambiarMail {
    ...
    @XmlElementRef(name = "NuevoMail", namespace = "http://vas.personal.com.py", type = JAXBElement.class, required = false)
    protected JAXBElement<String> nuevoMail;
    ...
    /**
     * Gets the value of the nuevoMail property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getNuevoMail() {
        return nuevoMail;
    }

    /**
     * Sets the value of the nuevoMail property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setNuevoMail(JAXBElement<String> value) {
        this.nuevoMail = value;
    }
