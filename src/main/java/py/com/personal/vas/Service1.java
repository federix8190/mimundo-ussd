 ...
 * 
 */
@WebServiceClient(name = "Service1", targetNamespace = "http://vas.personal.com.py", wsdlLocation = "http://10.129.5.54:8080/WsMiMundo/Service1.svc?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICE1_QNAME = new QName("http://vas.personal.com.py", "Service1");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://10.129.5.54:8080/WsMiMundo/Service1.svc?wsdl");
    ...
    public IService1 getBasicHttpBindingIService1() {
        return super.getPort(new QName("http://vas.personal.com.py", "BasicHttpBinding_IService1"), IService1.class);
    }
    ...
    public IService1 getBasicHttpBindingIService1(WebServiceFeature... features) {
        return super.getPort(new QName("http://vas.personal.com.py", "BasicHttpBinding_IService1"), IService1.class, features);
    }
